...
class OrderbookManagerImplSpec extends CommonSpec {
  ...
  "OrderbookManagerImplSpec" should "process very small slot" in {
    ...
    obm.getOrderbook(0, 100) should be(XOrderbook(0, Seq(
      XOrderbook.XItem("0.00001", "10.00", "100.0")
    ), Nil))

    obm.getOrderbook(1, 100) should be(XOrderbook(0, Seq(
  ...
  "OrderbookManagerImplSpec" should "process buy slot and round down" in {
    ...
    obm.getOrderbook(0, 100) should be(XOrderbook(0, Nil, Seq(
      XOrderbook.XItem("0.12344", "10.00", "100.0")
    )))

    obm.getOrderbook(1, 100) should be(XOrderbook(0, Nil, Seq(
  ...
  "OrderbookManagerImplSpec" should "skip slots with lower or equal sell prices" in {
    ...
    obm.getOrderbook(0, 100, Some(0.12343)) should be(XOrderbook(0.12343, Seq(
      XOrderbook.XItem("0.12344", "5.00", "40.0"),
      XOrderbook.XItem("0.12345", "10.00", "80.0")
    ), Nil))

    obm.getOrderbook(0, 100, Some(0.12344)) should be(XOrderbook(0.12344, Seq(
      // XOrderbook.XItem("0.12344", "5.00", "40.0"),
      XOrderbook.XItem("0.12345", "10.00", "80.0")
    ), Nil))

    obm.getOrderbook(0, 100, Some(0.123445)) should be(XOrderbook(0.123445, Seq(
      XOrderbook.XItem("0.12345", "10.00", "80.0")
    ), Nil))

    obm.getOrderbook(0, 100, Some(0.12345)) should be(XOrderbook(0.12345, Nil, Nil))
  }
  ...
  "OrderbookManagerImplSpec" should "skip slots with higer buy prices" in {
    ...
    obm.getOrderbook(0, 100, Some(0.12346)) should be(XOrderbook(0.12346, Nil, Seq(
      XOrderbook.XItem("0.12345", "10.00", "80.0"),
      XOrderbook.XItem("0.12344", "5.00", "40.0")
    )))

    obm.getOrderbook(0, 100, Some(0.12345)) should be(XOrderbook(0.12345, Nil, Seq(
      XOrderbook.XItem("0.12345", "10.00", "80.0"),
      XOrderbook.XItem("0.12344", "5.00", "40.0")
    )))

    obm.getOrderbook(0, 100, Some(0.123445)) should be(XOrderbook(0.123445, Nil, Seq(
      XOrderbook.XItem("0.12344", "5.00", "40.0")
    )))

    obm.getOrderbook(0, 100, Some(0.12344)) should be(XOrderbook(0.12344, Nil, Seq(
      XOrderbook.XItem("0.12344", "5.00", "40.0")
    )))

    obm.getOrderbook(0, 100, Some(0.123435)) should be(XOrderbook(0.123435, Nil, Nil))
  }
