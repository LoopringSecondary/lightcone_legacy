...
//         _matchable = Some(
//           OrderState(
//             amountS = makerAmountS,
//             amountB = makerAmountB,
//             amountFee = makerFee
//           )
//         )
//       )
...
//         _matchable = Some(
//           OrderState(
//             amountS = takerAmountS / 2,
//             amountB = takerAmountB / 2,
//             amountFee = takerFee / 2
//           )
//         )
//       ),
//       maker.copy(
//         _matchable = Some(
//           OrderState(
//             amountS = makerAmountS / 2,
//             amountB = makerAmountB / 2,
//             amountFee = makerFee / 2
//           )
//         )
//       )
//     )
...
//               amountFee = Rational(makerFee) - Rational(
//                 makerFee * (makerAmountS - takerAmountB / 2),
//                 makerAmountS
//               )
//             )
//           )
...
//           amountFee =
//             Rational(makerFee * (makerAmountS - takerAmountB / 2), makerAmountS)
//         ),
//         amountMargin = BigInt(0)
//       )
//     )
