...
import static org.loopring.lightcone.ethereum.solidity.SolidityHashUtil.sha3;
import static org.loopring.lightcone.ethereum.solidity.SolidityType.IntType.decodeInt;
import static org.loopring.lightcone.ethereum.solidity.SolidityType.IntType.encodeInt;
...
public class SolidityAbi extends ArrayList<SolidityAbi.Entry> {
  ...
  public static class Constructor extends Entry {
    ...
    public Constructor(
        List<SolidityAbi.Entry.Param> inputs, List<SolidityAbi.Entry.Param> outputs) {
