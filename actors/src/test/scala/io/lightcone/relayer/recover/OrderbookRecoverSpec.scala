  ...
  "recover an orderbook" must {
    "get market's orderbook updates" in {
      ...
      system.actorSelection(
        "akka://Lightcone/system/sharding/orderbook_manager/orderbook_manager_464977589/orderbook_manager_464977589") ! PoisonPill
      system.actorSelection(
        "akka://Lightcone/system/sharding/orderbook_manager/orderbook_manager_1749215251/orderbook_manager_1749215251") ! PoisonPill
      ...
      try {
        ...
        case e: ErrorException if e.error.code == ErrorCode.ERR_INTERNAL_UNKNOWN && e
          .getMessage()
    ...
    val rawOrders =
      Seq(
        createRawOrder( // sell 20 LRC, price = 1/20 = 0.05
          ...
          amountFee = 2.toString.zeros(LRC_TOKEN.decimals))(account1),
        createRawOrder( // sell 21 LRC, price = 1/21 = 0.047620
          tokenB = WETH_TOKEN.address,
          tokenS = LRC_TOKEN.address,
          amountB = "1".zeros(WETH_TOKEN.decimals),
          amountS = "21".zeros(LRC_TOKEN.decimals),
          amountFee = 3.toString.zeros(LRC_TOKEN.decimals))(account1),
        createRawOrder( // sell 100 LRC, price = 1/100 = 0.01
          tokenB = WETH_TOKEN.address,
          tokenS = LRC_TOKEN.address,
          amountB = "1".zeros(WETH_TOKEN.decimals),
          amountS = "100".zeros(LRC_TOKEN.decimals),
          amountFee = 4.toString.zeros(LRC_TOKEN.decimals))(account1),
        ...
        createRawOrder( // buy 300 LRC, price = 1/300 = 0.003333
          ...
          amountFee = 1.toString.zeros(LRC_TOKEN.decimals))(account2),
