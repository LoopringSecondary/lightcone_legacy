...
object Dispatchers {
  ...
  class AllowanceEventDispatcher @Inject() (
    actors: Lookup[ActorRef])(
      implicit extractor: EventExtractor[AddressAllowanceUpdated],
      ec: ExecutionContext)
  ...
  class BalanceEventDispatcher @Inject() (
    actors: Lookup[ActorRef])(
      implicit extractor: EventExtractor[AddressBalanceUpdated],
      ec: ExecutionContext)
  ...
  class CutoffEventDispatcher @Inject() (
    actors: Lookup[ActorRef])(
      implicit extractor: EventExtractor[CutoffEvent],
      ec: ExecutionContext)
  ...
  class OrderFilledEventDispatcher @Inject() (
    actors: Lookup[ActorRef])(
      implicit extractor: EventExtractor[OrderFilledEvent],
      ec: ExecutionContext)
  ...
  class OrdersCancelledEventDispatcher @Inject() (
    actors: Lookup[ActorRef])(
      implicit extractor: EventExtractor[OrdersCancelledEvent],
      ec: ExecutionContext)
  ...
  class TokenBurnRateChangedEventDispatcher @Inject() (
    actors: Lookup[ActorRef])(
      implicit extractor: EventExtractor[TokenBurnRateChangedEvent],
      ec: ExecutionContext)
  ...
  class TransferEventDispatcher @Inject() (
    actors: Lookup[ActorRef])(
      implicit extractor: EventExtractor[TransferEvent],
      ec: ExecutionContext)
  ...
  class OHLCRawDataEventDispatcher @Inject() (
    actors: Lookup[ActorRef])(
      implicit extractor: EventExtractor[OHLCRawData],
      ec: ExecutionContext)
  ...
  class BlockGasPricesDispatcher @Inject() (
    actors: Lookup[ActorRef])(
      implicit extractor: EventExtractor[BlockGasPrices],
      ec: ExecutionContext)
