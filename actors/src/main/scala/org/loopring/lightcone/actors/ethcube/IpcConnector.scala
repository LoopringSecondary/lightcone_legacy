...
import org.loopring.lightcone.eth_jsonrpc.{ EthereumProxySettings, JsonRpcReq, JsonRpcRes }
import scalapb.json4s.JsonFormat

private[actors] class IpcConnector(node: EthereumProxySettings.Node)
  extends Actor
  with ActorLogging {
